...
const { create, update, removal, restore,findAll } = require('../controller/goodsController')
...
router.post('/upload', auth, hadAdminPermission, fileValidator(UPLOAD_TYPE), upload);
